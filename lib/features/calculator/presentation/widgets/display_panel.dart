          ...
          child: Column(
            ...
            children: [
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            style: AppTextStyles.calculatorHistory.copyWith(color: theme.textSecondary, fontSize: 16),
                          ),
                        ),
              ...
              AutoFitText(
                ...
                maxFontSize: AppTextStyles.calculatorExpression.fontSize!,
                minFontSize: 20,
                color: theme.textPrimary,
                fontWeight: AppTextStyles.calculatorExpression.fontWeight!,
                textAlign: TextAlign.right,
                showCursor: true,
              ...
              AutoFitText(
                ...
                fontWeight: AppTextStyles.calculatorPreview.fontWeight!,
                textAlign: TextAlign.right,
              ),
            ],
          ),
